...
static const int X_IN_LOW = 750; // Extreme Left value
static const int X_IN_HIGH = 2250;// Extreme Right value
static const int Y_IN_LOW = 750; // Extreme Rearward value
static const int Y_IN_HIGH = 2250;// Extreme Foreward value
static const int ROT_IN_LOW = 750; // Extreme ClockWise value
static const int ROT_IN_HIGH = 2250;// Extreme CounterClockWise value
...
void identifyWheels();
void octagon();
void moveJoystick(int X_IN_LOW, int X_IN_HIGH, int X, int Y_IN_LOW, int Y_IN_HIGH, int Y, int ROT_IN_LOW, int ROT_IN_HIGH, int ROT);
...
=======
Serial.print(X_IN_LOW);
Serial.print(", ");
Serial.print(X_IN_HIGH);
Serial.print(", ");
Serial.print(X);
Serial.print(", ");
Serial.print(Y_IN_LOW);
Serial.print(", ");
Serial.print(Y_IN_HIGH);
Serial.print(", ");
Serial.print(Y);
Serial.print(", ");
Serial.print(ROT_IN_LOW);
Serial.print(", ");
Serial.print(ROT_IN_HIGH);
>>>>>>> fixed omniRC
Serial.print(", ");
Serial.print(ROT);
Serial.println("");
